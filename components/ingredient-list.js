...
function IngredientList(props) {
  ...
  return (
    <div className="container bg-primary w-full md:w-72 min-h-fit">
      <div className="card md:w-72 bg-accent dark:bg-neutral rounded-3xl shadow-[0px_0px_5px_0px_rgba(0,0,0,0.2)] dark:shadow-accent/50 min-h-fit">
