...
function IngredientList(props) {
  ...
  return (
    <div>
      ...
      <label
        htmlFor="my-modal-4"
        className="btn btn-circle btn-primary btn-lg modal-button shadow-[0px_0px_5px_0px_rgba(0,0,0,0.5)]"
      >
        <svg
          className="bi bi-basket color: white w-8 h-8 animate-pulse"
