    ...
    <div className="card w-fit h-fit glass image-full hover:shadow-2xl m-5">
      ...
      <div className="card-body p-5 cursor-none">    
        ...
        <div className="card-actions justify-end">
          <button className="btn btn-circle btn-outline text-base-100" onClick={ unBookmarked }>
            <svg className="bi bi-bookmark-x color: rgb(255, 210, 51); h-7 w-7" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
              <path fillRule="evenodd" d="M6.146 5.146a.5.5 0 0 1 .708 0L8 6.293l1.146-1.147a.5.5 0 1 1 .708.708L8.707 7l1.147 1.146a.5.5 0 0 1-.708.708L8 7.707 6.854 8.854a.5.5 0 1 1-.708-.708L7.293 7 6.146 5.854a.5.5 0 0 1 0-.708z" fill="#ffd233"></path>
